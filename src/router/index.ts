...

    {
      ...
      children: [
        ...
        },
        {
          path: 'levels',
          name: 'admin-levels',
          component: () => import('@/views/admin/AdminLevelListView.vue'),
          meta: { title: 'Levels', subtitle: 'Benefits, services, questions and pass criteria' },
        },
        {
          path: 'levels/:id',
          name: 'admin-level-detail',
          component: () => import('@/views/admin/AdminLevelDetailView.vue'),
          props: true,
          meta: { title: 'Level detail' },
        },
        {
          path: 'levels/:id/edit',
          name: 'admin-level-edit',
          component: () => import('@/views/admin/AdminLevelEditView.vue'),
          props: true,
          meta: { title: 'Edit level' },
        },
      ],
    },
